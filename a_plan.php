...
$html = file_get_html('something/union/a.html');
...
for ($i = 0; $i < 11; $i++) {
    $sql = "insert into a_plan values($monthly_fee[$i], $total_phone[$i], $flow[$i], $message[$i], $video[$i],$phone_m[$i],$video_m,$flow_k,$message_m)";
    //加入数据库
    mysql_query($sql, $con);
}
